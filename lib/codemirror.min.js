!function(e, t) {
    ...
    function Q(e, t) {
        var r;
        return r = Object.create ? Object.create(e) : (Z.prototype = e, new Z), t && I(t, r), r
    }
    ...
    var ue,
        ...
        ve = (ue = "bbbbbbbbbtstwsbbbbbbbbbbbbbbssstwNN%%%NNNNNN,N,N1111111111NNNNNNNLLLLLLLLLLLLLLLLLLLLLLLLLLNNNNNNLLLLLLLLLLLLLLLLLLLLLLLLLLNNNNbbbbbbsbbbbbbbbbbbbbbbbbbbbbbbbbb,N%%%%NNNNLNNNNN%%11NLNNN1LNNNNNLLLLLLLLLLLLLLLLLLLLLLLNLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLN", ce = "nnnnnnNNr%%r,rNNmmmmmmmmmmmrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrmmmmmmmmmmmmmmmmmmmmmnnnnnnnnnn%nnrrrmrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrmmmmmmmnNmmmmmmrrmmNmmmmrr1111111111", he = /[\u0590-\u05f4\u0600-\u06ff\u0700-\u08ac]/, fe = /[stwN]/, de = /[LRr]/, pe = /[Lb1n]/, ge = /[1n]/, function(e, t) {
            ...
            return "ltr" == t && (1 == A[0].level && (O = e.match(/^\s+/)) && (A[0].from = O[0].length, A.unshift(new me(0, 0, O[0].length))), 1 == $(A).level && (O = e.match(/\s+$/)) && ($(A).to -= O[0].length, A.push(new me(0, i - O[0].length, i)))), "rtl" == t ? A.reverse() : A
        });
    function me(e, t, r) {
        this.level = e,
        this.from = t,
    ...
    function Le(e, t, r) {
        ...
        }), Se(e, r || t.type, e, t), Ae(t) || t.codemirrorIgnore
    }
    function ke(e) {
    ...
    function He(e) {
        var t = e.which;
        return null == t && (1 & e.button ? t = 1 : 2 & e.button ? t = 3 : 4 & e.button && (t = 2)), w && e.ctrlKey && 1 == t && (t = 3), t
    }
    var Fe,
        Pe,
        Ee = function() {
    ...
    var Re,
        ...
        Ue = "oncopy" in (Re = A("div")) || (Re.setAttribute("oncopy", "return;"), "function" == typeof Re.oncopy),
        Ve = null;
    var Ke = {},
        je = {};
    function Xe(e) {
    ...
    function gt(e, t) {
        ...
        var r,
            ...
            i,
            o = e.first + e.size - 1;
        return t.line > o ? at(o, et(e, o).text.length) : (n = et(e, (r = t).line).text.length, null == (i = r.ch) || n < i ? at(r.line, n) : i < 0 ? at(r.line, 0) : r)
    }
    function vt(e, t) {
    ...
    function Nt(e, t, r, n, i, o, l) {
        ...
        for ("" == t && Mt(St(r, n.state), o); !h.eol();) {
            if (a = h.pos > e.options.maxHighlightLength ? (s = !1, l && Ct(e, t, n, h.pos), h.pos = t.length, null) : Mt(Lt(r, h, n.state, f), o), f) {
                var d = f[0].name;
                d && (a = "m-" + (a ? d + " " + a : d))
            }
            if (!s || c != a) {
    ...
    function ir(e, t) {
        ...
        for (var i = 0; i <= (t.rest ? t.rest.length : 0); i++) {
            ...
            o.styleClasses && (o.styleClasses.bgClass && (n.bgClass = F(o.styleClasses.bgClass, n.bgClass || "")), o.styleClasses.textClass && (n.textClass = F(o.styleClasses.textClass, n.textClass || ""))),
        ...
        return Se(e, "renderLine", e, t.line, n.pre), n.pre.className && (n.textClass = F(n.pre.className, n.textClass || "")), n
    }
    function or(e) {
            ...
            if (u.test(t)) {
                ...
                for (var h = 0;;) {
                    ...
                    if ("\t" == f[0]) {
                        ...
                        "\r" == f[0] || "\n" == f[0] ? (g = s.appendChild(A("span", "\r" == f[0] ? "␍" : "␤", "cm-invalidchar"))).setAttribute("cm-text", f[0]) : ((g = e.cm.options.specialCharPlaceholder(f[0])).setAttribute("cm-text", f[0]), x && C < 9 ? s.appendChild(A("span", [g])) : s.appendChild(g)),
                        e.col += 1;
                ...
                x && C < 9 && (c = !0),
                e.pos += t.length;
            if (e.trailingSpace = 32 == a.charCodeAt(t.length - 1), r || n || i || c || o) {
                var y = r || "";
                n && (y += n),
                i && (y += i);
                var b = A("span", [s], y, o);
                ...
                if (m == p) {
                    ...
                    if (!h || h.from == p)
                        for (var k = 0; k < y.length; ++k)
                            ar(t, 0, y[k]);
                    if (h && (h.from || 0) == p) {
                        if (ar(t, (null == h.to ? d + 1 : h.to) - p, h.marker, null == h.from), null == h.to)
                            return;
                        h.to == p && (h = !1)
                    }
                }
    ...
    function gr(e, t) {
        ...
        if (r.length) {
            ...
            fr ? n = fr.delayedCallbacks : pr ? n = pr : (n = pr = [], setTimeout(vr, 0));
    ...
    function mr(e, t, r, n) {
        for (var i = 0; i < t.changes.length; i++) {
            var o = t.changes[i];
            "text" == o ? wr(e, t) : "gutter" == o ? Cr(e, t, r, n) : "class" == o ? xr(e, t) : "widget" == o && Sr(e, t, n)
        }
        t.changes = null
    }
    function yr(e) {
        return e.node == e.text && (e.node = A("div", null, null, "position: relative"), e.text.parentNode && e.text.parentNode.replaceChild(e.node, e.text), e.node.appendChild(e.text), x && C < 8 && (e.node.style.zIndex = 2)), e.node
    }
    function br(e, t) {
        var r = e.display.externalMeasured;
        return r && r.line == t.line ? (e.display.externalMeasured = null, t.measure = r.measure, r.built) : ir(e, t)
    }
    function wr(e, t) {
        ...
        t.text = n.pre,
        n.bgClass != t.bgClass || n.textClass != t.textClass ? (t.bgClass = n.bgClass, t.textClass = n.textClass, xr(e, t)) : r && (t.text.className = r)
    }
    function xr(e, t) {
        !function(e, t) {
        ...
        t.line.wrapClass ? yr(t).className = t.line.wrapClass : t.node != t.text && (t.node.className = "");
    ...
    function Cr(e, t, r, n) {
        ...
        if (e.options.lineNumbers || o) {
            ...
            if (e.display.input.setUneditable(s), l.insertBefore(s, t.text), t.line.gutterClass && (s.className += " " + t.line.gutterClass), !e.options.lineNumbers || o && o["CodeMirror-linenumbers"] || (t.lineNumber = s.appendChild(A("div", st(e.options, r), "CodeMirror-linenumber CodeMirror-gutter-elt", "left: " + n.gutterLeft["CodeMirror-linenumbers"] + "px; width: " + e.display.lineNumInnerWidth + "px"))), o)
    ...
    function Sr(e, t, r) {
        ...
        for (var n = L("CodeMirror-linewidget"), i = t.node.firstChild, o = void 0; i; i = o)
            o = i.nextSibling,
    ...
    function zr(e, t) {
        var r = it(t),
            n = Ir(e, r);
        n && !n.text ? n = null : n && n.changes && (mr(e, n, r, cn(e)), e.curOp.forceUpdate = !0);
        var i = Pr(n = n || function(e, t) {
            var r = it(t = Xt(t)),
            ...
            if (3 == l.nodeType) {
                for (var c = 0; c < 4; c++) {
                    ...
                    for (; o.coverStart + a < o.coverEnd && ie(t.line.text.charAt(o.coverStart + a));)
                        ++a;
                    if ((i = x && C < 9 && 0 == s && a == o.coverEnd - o.coverStart ? l.parentNode.getBoundingClientRect() : Vr(k(l, s, a).getClientRects(), n)).left || i.right || 0 == s)
                        break;
                    a = s,
                    --s,
                    u = "right"
    ...
    function qr(e, t, r, n, i) {
        ...
        n = n || "local";
        var l = Zt(t);
        if ("local" == n ? l += Or(e.display) : l -= e.display.viewOffset, "page" == n || "window" == n) {
    ...
    function Jr(n, e, i, o, l, s) {
        ...
        var u = ye(o, n.doc.direction),
            t = e.ch,
            r = e.sticky;
        if (t >= o.text.length ? (t = o.text.length, r = "before") : t <= 0 && (t = 0, r = "after"), !u)
    ...
    function en(e, t) {
        var r = 0;
        t = gt(e.doc, t),
        e.options.lineWrapping || (r = un(e.display) * t.ch);
    ...
    function sn(r, e, t, n, i) {
        ...
        if (c) {
            var h = (r.options.lineWrapping ? function(e, t, r, n, i, o, l) {
                ...
                for (var c = null, h = null, f = 0; f < i.length; f++) {
                    ...
                    if (!(d.from >= u || d.to <= a)) {
                        var p = 1 != d.level,
                            g = Rr(e, n, p ? Math.min(u, d.to) - 1 : Math.max(a, d.from)).right,
                            v = g < o ? o - g + 1e9 : g - o;
                        (!c || v < h) && (c = d, h = v)
                    }
                }
                ...
                var e = le(function(e) {
                        var t = s[e],
                            r = 1 != t.level;
                        return ln(Jr(n, at(o, r ? t.to : t.from, r ? "before" : "after"), "line", i, l), a, u, !0)
                    }, 0, s.length - 1),
                    t = s[e];
                if (0 < e) {
                    var r = 1 != t.level,
                        c = Jr(n, at(o, r ? t.from : t.to, r ? "after" : "before"), "line", i, l);
        ...
        var f,
            ...
            v = le(function(e) {
                var t = Rr(r, o, e);
                return t.top += l, t.bottom += l, ln(t, n, i, !1) && (t.top <= i && t.left <= n && (p = e, g = t), 1)
            }, s, a),
            m = !1;
        if (g) {
            ...
            u || v != a && v != s || v++,
            d = 0 == v ? "after" : v == e.text.length ? "before" : Rr(r, o, v - (u ? 1 : 0)).bottom + l <= i == u ? "after" : "before";
    ...
    function pn(e, t, r, n) {
        ...
        if (n && 0 < u.xRel && (a = et(e.doc, u.line).text).length == u.ch) {
            ...
            u = at(u.line, Math.max(0, Math.round((o - Dr(e.display).left) / un(e.display)) - c))
        }
        return u
    }
    function gn(e, t) {
    ...
    function vn(e, t, r, n) {
        ...
        n = n || 0;
        var i = e.display;
        if (n && r < i.viewTo && (null == i.updateLineNumbers || i.updateLineNumbers > t) && (i.updateLineNumbers = t), e.curOp.viewChanged = !0, t >= i.viewTo)
            At && Yt(e.doc, t) < i.viewTo && yn(e);
        else if (r <= i.viewFrom)
            At && _t(e.doc, r + n) > i.viewFrom ? yn(e) : (i.viewFrom += n, i.viewTo += n);
        else if (t <= i.viewFrom && r >= i.viewTo)
            yn(e);
        else if (t <= i.viewFrom) {
            var o = bn(e, r, r + n, 1);
            o ? (i.view = i.view.slice(o.index), i.viewFrom = o.lineN, i.viewTo += n) : yn(e)
        } else if (r >= i.viewTo) {
            var l = bn(e, t, t, -1);
            ...
            var s = bn(e, t, t, -1),
                a = bn(e, r, r + n, 1);
            s && a ? (i.view = i.view.slice(0, s.index).concat(hr(e, s.lineN, a.lineN)).concat(i.view.slice(a.index)), i.viewTo += n) : yn(e)
        }
    ...
    function kn(l, e, t) {
        ...
        if (a.line == u.line)
            ...
            f && (d.top < p.top - 2 ? (O(d.right, d.top, null, d.bottom), O(T, p.top, p.left, p.bottom)) : O(d.right, d.top, p.left - d.right, d.bottom)),
    ...
    function On(e, t) {
        ...
        "nocursor" != e.options.readOnly && (e.state.focused || (Se(e, "focus", e, t), e.state.focused = !0, H(e.display.wrapper, "CodeMirror-focused"), e.curOp || e.display.selForContextMenu == e.doc.sel || (e.display.input.reset(), b && setTimeout(function() {
            return e.display.input.reset(!0)
        }, 20)), e.display.input.receivedFocus()), Tn(e))
    }
    function An(e, t) {
        e.state.delayingBlurEvent || (e.state.focused && (Se(e, "blur", e, t), e.state.focused = !1, T(e.display.wrapper, "CodeMirror-focused")), clearInterval(e.display.blinker), setTimeout(function() {
    ...
    function Dn(e) {
        for (var t = e.display, r = t.lineDiv.offsetTop, n = 0; n < t.view.length; n++) {
            ...
            if (!i.hidden) {
                ...
                if ((.005 < c || c < -.005) && (nt(i.line, l), Wn(i.line), i.rest))
    ...
    function Hn(e, t, r) {
        ...
        if (r && r.ensure) {
            var s = r.ensure.from.line,
                a = r.ensure.to.line;
            s < o ? l = ot(t, Zt(et(t, o = s)) + e.wrapper.clientHeight) : Math.min(a, t.lastLine()) >= l && (o = ot(t, Zt(et(t, a)) - e.wrapper.clientHeight), l = a)
        }
        return {
            from: o,
            to: Math.max(l, o + 1)
    ...
    function zn(e) {
        ...
        t && (e.curOp.scrollToPos = null, Rn(e, en(e, t.from), en(e, t.to), t.margin))
    }
    function Rn(e, t, r, n) {
        var i = Fn(e, {
    ...
    function Bn(e, t) {
        Math.abs(e.doc.scrollTop - t) < 2 || (g || fi(e, {
            top: t
        }), Gn(e, t, !0), g && fi(e), si(e, 100))
    }
    function Gn(e, t, r) {
    ...
    function Un(e, t, r, n) {
        ...
        (r ? t == e.doc.scrollLeft : Math.abs(e.doc.scrollLeft - t) < 2) && !n || (e.doc.scrollLeft = t, gi(e), e.display.scroller.scrollLeft != t && (e.display.scroller.scrollLeft = t), e.display.scrollbars.setScrollLeft(t))
    }
    function Vn(e) {
        var t = e.display,
    ...
    function Yn(e, t) {
        ...
        n.bottom && e.options.coverGutterNextToScrollbar && e.options.fixedGutter ? (r.gutterFiller.style.display = "block", r.gutterFiller.style.height = n.bottom + "px", r.gutterFiller.style.width = t.gutterWidth + "px") : r.gutterFiller.style.display = ""
    }
    ...
    function $n(r) {
        r.display.scrollbars && (r.display.scrollbars.clear(), r.display.scrollbars.addClass && T(r.display.wrapper, r.display.scrollbars.addClass)),
        r.display.scrollbars = new _n[r.options.scrollbarStyle](function(e) {
    ...
    function Zn(e) {
        ...
        t = e.curOp,
        fr ? fr.ops.push(t) : t.ownsGroup = fr = {
            ops: [t],
            delayedCallbacks: []
        }
    }
    ...
    function Jn(e) {
        var t,
            ...
            n = e.cm,
            i = n.display;
        !(r = (t = n).display).scrollbarsClipped && r.scroller.offsetWidth && (r.nativeBarWidth = r.scroller.offsetWidth - r.scroller.clientWidth, r.heightForcer.style.height = Wr(t) + "px", r.sizer.style.marginBottom = -r.nativeBarWidth + "px", r.sizer.style.borderRightWidth = Wr(t) + "px", r.scrollbarsClipped = !0),
        ...
        e.update = e.mustUpdate && new ui(n, e.mustUpdate && {
            top: e.scrollTop,
    ...
    function ei(e) {
        ...
        e.barMeasure = Vn(t),
        r.maxLineChanged && !t.options.lineWrapping && (e.adjustWidthTo = Er(t, r.maxLine, r.maxLine.text.length).left + 3, t.display.sizerWidth = e.adjustWidthTo, e.barMeasure.scrollWidth = Math.max(r.scroller.clientWidth, r.sizer.offsetLeft + e.adjustWidthTo + Wr(t) + t.display.barWidth), e.maxScrollLeft = Math.max(0, r.sizer.offsetLeft + e.adjustWidthTo - Hr(t))),
    ...
    function ti(e) {
        ...
        !e.updatedDisplay && e.startHeight == t.doc.height || Xn(t, e.barMeasure),
        ...
        e.scrollToPos && function(e, t) {
            ...
            for (var o = 0; o < 5; o++) {
                var l = !1,
                    ...
                    c = e.doc.scrollTop,
                    h = e.doc.scrollLeft;
                if (null != u.scrollTop && (Bn(e, u.scrollTop), 1 < Math.abs(e.doc.scrollTop - c) && (l = !0)), null != u.scrollLeft && (Un(e, u.scrollLeft), 1 < Math.abs(e.doc.scrollLeft - h) && (l = !0)), !l)
                    break
            }
            return i
    ...
    function ci(e, t) {
        ...
        if (t.editorIsHidden)
            return yn(e), !1;
        if (!t.force && t.visible.from >= r.viewFrom && t.visible.to <= r.viewTo && (null == r.updateLineNumbers || r.updateLineNumbers >= r.viewTo) && r.renderedView == r.view && 0 == wn(e))
            return !1;
        ...
        var s,
            ...
            u,
            c,
            h = o != r.viewFrom || l != r.viewTo || r.lastWrapHeight != t.wrapperHeight || r.lastWrapWidth != t.wrapperWidth;
        a = o,
        u = l,
        0 == (c = (s = e).display).view.length || a >= c.viewTo || u <= c.viewFrom ? (c.view = hr(s, a, u), c.viewFrom = a) : (c.viewFrom > a ? c.view = hr(s, a, c.viewFrom).concat(c.view) : c.viewFrom < a && (c.view = c.view.slice(gn(s, a))), c.viewFrom = a, c.viewTo < u ? c.view = c.view.concat(hr(s, c.viewTo, u)) : c.viewTo > u && (c.view = c.view.slice(0, gn(s, u)))),
        c.viewTo = u,
        ...
        return 4 < f && (r.lineDiv.style.display = "none"), function(r, e, t) {
            var n = r.display,
            ...
            function s(e) {
                var t = e.nextSibling;
                return b && w && r.display.currentWheelTarget == e ? e.style.display = "none" : e.parentNode.removeChild(e), t
            }
            for (var a = n.view, u = n.viewFrom, c = 0; c < a.length; c++) {
                ...
                if (!h.hidden)
                    if (h.node && h.node.parentNode == o) {
                        ...
                        h.changes && (-1 < B(h.changes, "gutter") && (f = !1), mr(r, h, u, t)),
                        f && (M(h.lineNumber), h.lineNumber.appendChild(document.createTextNode(st(r.options, u)))),
                        l = h.node.nextSibling
                    } else {
                        var d = (v = u, m = t, y = br(p = r, g = h), g.text = g.node = y.pre, y.bgClass && (g.bgClass = y.bgClass), y.textClass && (g.textClass = y.textClass), xr(p, g), Cr(p, g, v, m), Lr(p, g, m), g.node);
                        o.insertBefore(d, l)
                    }
                u += h.size
            }
            ...
            for (; l;)
                l = s(l)
        }(e, r.updateLineNumbers, t.dims), 4 < f && (r.lineDiv.style.display = ""), r.renderedView = r.view, function(e) {
        ...
        }(d), M(r.cursorDiv), M(r.selectionDiv), r.gutters.style.height = r.sizer.style.minHeight = 0, h && (r.lastWrapHeight = t.wrapperHeight, r.lastWrapWidth = t.wrapperWidth, si(e, 400)), !(r.updateLineNumbers = null)
    }
    function hi(e, t) {
        for (var r = t.viewport, n = !0;; n = !1) {
            if (n && e.options.lineWrapping && t.oldDisplayWidth != Hr(e))
                ...
                top: Math.min(e.doc.height + Ar(e.display) - Fr(e), r.top)
            }), t.visible = Hn(e.display, e.doc, r), t.visible.from >= e.display.viewFrom && t.visible.to <= e.display.viewTo)
                break;
            if (!ci(e, t))
                break;
            Dn(e);
    ...
    function pi(e, t) {
        ...
        e.display.gutters.style.height = t.docHeight + e.display.barHeight + Wr(e) + "px"
    }
    function gi(e) {
        var t = e.display,
            r = t.view;
        if (t.alignWidgets || t.gutters.firstChild && e.options.fixedGutter) {
            for (var n = hn(t) - t.scroller.scrollLeft + e.doc.scrollLeft, i = t.gutters.offsetWidth, o = n + "px", l = 0; l < r.length; l++)
                if (!r[l].hidden) {
        ...
        if (e.options.lineNumbers) {
            ...
            if (r.length != n.lineNumChars) {
                var i = n.measure.appendChild(A("div", [A("div", r)], "CodeMirror-linenumber CodeMirror-gutter-elt")),
                    ...
                    l = i.offsetWidth - o;
                return n.lineGutter.style.width = "", n.lineNumInnerWidth = Math.max(o, n.lineGutter.offsetWidth - l) + 1, n.lineNumWidth = n.lineNumInnerWidth + l, n.lineNumChars = n.lineNumInnerWidth ? r.length : -1, n.lineGutter.style.width = n.lineNumWidth + "px", di(e.display), 1
            }
        }
    }
    function mi(e, t) {
    ...
    function ki(e, t) {
        ...
        if (n && s || i && a) {
            if (i && w && b)
                e:
                for (var u = t.target, c = o.view; u != l; u = u.parentNode)
            ...
            if (n && !g && !v && null != Ci)
                return i && a && Bn(e, Math.max(0, l.scrollTop + i * Ci)), Un(e, Math.max(0, l.scrollLeft + n * Ci)), (!i || i && a) && Ne(t), void (o.wheelStartX = null);
            if (i && null != Ci) {
                var f = i * Ci,
                    d = e.doc.scrollTop,
            ...
            xi < 20 && (null == o.wheelStartX ? (o.wheelStartX = l.scrollLeft, o.wheelStartY = l.scrollTop, o.wheelDX = n, o.wheelDY = i, setTimeout(function() {
    ...
    x ? Ci = -.53 : g ? Ci = 15 : l ? Ci = -.7 : a && (Ci = -1 / 3);
    var Ti = function(e, t) {
        this.ranges = e,
        this.primIndex = t
    };
    ...
    function Ui(e, t) {
        ...
        return Yi(e, r, t.from.line, t.to.line + 1), zi(e, function(e) {
    ...
    function Ki(e, t, r, n) {
        ...
        var o,
            ...
            s,
            a = +new Date;
        if ((i.lastOp == n || i.lastOrigin == t.origin && t.origin && ("+" == t.origin.charAt(0) && i.lastModTime > a - (e.cm ? e.cm.options.historyEventDelay : 500) || "*" == t.origin.charAt(0))) && (o = (s = i).lastOp == n ? (Vi(s.done), $(s.done)) : s.done.length && !$(s.done).ranges ? $(s.done) : 1 < s.done.length && !s.done[s.done.length - 2].ranges ? (s.done.pop(), $(s.done)) : void 0))
            l = $(o.changes),
            0 == ut(t.from, t.to) && 0 == ut(t.from, l.to) ? l.to = Ai(t) : o.changes.push(Ui(e, t));
        else {
            var u = $(i.done);
            for (u && u.ranges || Xi(e.sel, i.done), o = {
                changes: [Ui(e, t)],
    ...
    function ji(e, t, r, n) {
        var i,
            ...
            u = e.history,
            c = n && n.origin;
        r == u.lastSelOp || c && u.lastSelOrigin == c && (u.lastModTime == u.lastSelTime && u.lastOrigin == c || (i = e, o = c, l = $(u.done), s = t, "*" == (a = o.charAt(0)) || "+" == a && l.ranges.length == s.ranges.length && l.somethingSelected() == s.somethingSelected() && new Date - i.history.lastSelTime <= (i.cm ? i.cm.options.historyEventDelay : 500))) ? u.done[u.done.length - 1] = t : Xi(t, u.done),
    ...
    function qi(e, t, r) {
        for (var n = [], i = 0; i < e.length; ++i) {
            var o = e[i];
            if (o.ranges)
                n.push(r ? Ti.prototype.deepCopy.call(o) : o);
            else {
                var l = o.changes,
                    s = [];
                n.push({
                ...
                for (var a = 0; a < l.length; ++a) {
                    ...
                    if (s.push({
                        ...
                        for (var h in u)
                            (c = h.match(/^spans_(\d+)$/)) && -1 < B(t, Number(c[1])) && ($(s)[h] = u[h], delete u[h])
                }
            }
        }
        return n
    ...
    function eo(e, t, r, n) {
        ...
        i[t] = r,
        no(e, Ni(e.cm, i, e.sel.primIndex), n)
    }
    function to(e, t, r, n) {
        no(e, Oi(t, r), n)
    }
    ...
    function no(e, t, r) {
        io(e, t, r),
        ji(e, e.sel, e.cm ? e.cm.curOp.id : NaN, r)
    }
    function io(e, t, r) {
        var n,
            i,
            o,
            l;
        (Te(e, "beforeSelectionChange") || e.cm && Te(e.cm, "beforeSelectionChange")) && (n = e, o = r, l = {
            ranges: (i = t).ranges,
            update: function(e) {
                this.ranges = [];
                for (var t = 0; t < e.length; t++)
            ...
            origin: o && o.origin
        }, Se(n, "beforeSelectionChange", n, l), n.cm && Se(n.cm, "beforeSelectionChange", n.cm, l), t = l.ranges != i.ranges ? Ni(n.cm, l.ranges, l.ranges.length - 1) : i);
        var s = r && r.bias || (ut(t.primary().head, e.sel.primary().head) < 0 ? -1 : 1);
        oo(e, so(e, t, s, !0)),
        r && !1 === r.scroll || !e.cm || En(e.cm)
    }
    function oo(e, t) {
        t.equals(e.sel) || (e.sel = t, e.cm && (e.cm.curOp.updateInput = 1, e.cm.curOp.selectionChanged = !0, ke(e.cm)), gr(e, "cursorActivity", e))
    }
    function lo(e) {
    ...
    function so(e, t, r, n) {
        for (var i, o = 0; o < t.ranges.length; o++) {
            ...
            !i && a == l.anchor && u == l.head || ((i = i || t.ranges.slice(0, o))[o] = new Mi(a, u))
        }
                ...
                if ((null == s.from || (u ? s.from <= t.ch : s.from < t.ch)) && (null == s.to || (c ? s.to >= t.ch : s.to > t.ch))) {
                    ...
                    if (r) {
                        var h = a.find(n < 0 ? 1 : -1),
                            f = void 0;
                        if ((n < 0 ? c : u) && (h = co(e, h, -n, h && h.line == t.line ? o : null)), h && h.line == t.line && (f = ut(h, r)) && (n < 0 ? f < 0 : 0 < f))
                            return ao(e, h, t, n, i)
                    }
                    var d = a.find(n < 0 ? -1 : 1);
                    return (n < 0 ? u : c) && (d = co(e, d, n, d.line == t.line ? o : null)), d ? ao(e, d, t, n, i) : null
                }
            }
        return t
    }
    function uo(e, t, r, n, i) {
        var o = n || 1,
            l = ao(e, t, r, o, i) || !i && ao(e, t, r, o, !0) || ao(e, t, r, -o, i) || !i && ao(e, t, r, -o, !0);
    ...
    function po(e, t, r) {
        if (e.cm) {
            if (!e.cm.curOp)
                return ii(e.cm, po)(e, t, r);
            if (e.cm.state.suppressEdits)
                return
        }
        if (!(Te(e, "beforeChange") || e.cm && Te(e.cm, "beforeChange")) || (t = fo(e, t, !0))) {
    ...
    function go(e, r) {
        if (1 != r.text.length || "" != r.text[0] || 0 != ut(r.from, r.to)) {
            var t = Wi(e, r);
            Ki(e, r, t, e.cm ? e.cm.curOp.id : NaN),
            yo(e, r, t, Ft(e, r));
            var n = [];
            zi(e, function(e, t) {
    ...
    function vo(i, o, e) {
        ...
        if (!t || e) {
            for (var l, r = i.history, n = i.sel, s = "undo" == o ? r.done : r.undone, a = "undo" == o ? r.undone : r.done, u = 0; u < s.length && (l = s[u], e ? !l.ranges || l.equals(i.sel) : l.ranges); u++)
                ;
            if (u != s.length) {
    ...
    function mo(e, t) {
        if (0 != t && (e.first += t, e.sel = new Ti(q(e.sel.ranges, function(e) {
            return new Mi(at(e.anchor.line + t, e.anchor.ch), at(e.head.line + t, e.head.ch))
        ...
        if (t.to.line < e.first)
            ...
            e.cm ? function(e, t, r) {
                var n = e.doc,
                    ...
                    s = !1,
                    a = o.line;
                e.options.lineWrapping || (a = it(Xt(et(n, o.line))), n.iter(a, l.line + 1, function(e) {
                    if (e == i.maxLine)
                        return s = !0
                }));
                ...
                t.full ? vn(e) : o.line != l.line || 1 != t.text.length || Ei(e.doc, t) ? vn(e, o.line, l.line + 1, u) : mn(e, o.line, "text");
                var c = Te(e, "changes"),
                    h = Te(e, "change");
                if (h || c) {
                    var f = {
        ...
        for (var i = 0; i < e.length; ++i) {
            ...
            if (o.ranges) {
                ...
                for (var s = 0; s < o.ranges.length; s++)
                    wo(o.ranges[s].anchor, t, r, n),
                    wo(o.ranges[s].head, t, r, n)
            } else {
    ...
    function So(e, t, r, n) {
        var i = t,
            o = t;
        return "number" == typeof t ? o = et(e, pt(e, t)) : i = it(t), null == i ? null : (n(o, i) && e.cm && mn(e.cm, i, r), o)
    }
    function Lo(e) {
        this.lines = e,
        this.parent = null;
            ...
            for (var r = 0; r < this.children.length; ++r) {
                ...
                if (e < i) {
                    var o = Math.min(t, i - e),
                        l = n.height;
                    if (n.removeInner(e, o), this.height -= l - n.height, i == o && (this.children.splice(r--, 1), n.parent = null), 0 == (t -= o))
                        break;
                    e = 0
                } else
                    e -= i
            }
            if (this.size - t < 25 && (1 < this.children.length || !(this.children[0] instanceof Lo))) {
                var s = [];
                this.collapse(s),
    ...
    To.prototype.changed = function() {
        ...
        this.height = null;
        var i = Mr(this) - t;
        i && ($t(this.doc, n) || nt(n, n.height + i), r && ni(r, function() {
    ...
    function Ao(t, n, i, e, r) {
        ...
        if (t.cm && !t.cm.curOp)
            return ii(t.cm, Ao)(t, n, i, e, r);
        var o = new Oo(t, r),
            l = ut(n, i);
        if (e && I(e, o, !1), 0 < l || 0 == l && !1 !== o.clearWhenEmpty)
            return o;
        if (o.replacedWith && (o.collapsed = !0, o.widgetNode = O("span", [o.replacedWith], "CodeMirror-widget"), e.handleMouseEvents || o.widgetNode.setAttribute("cm-ignore-events", "true"), e.insertLeft && (o.widgetNode.insertLeft = !0)), o.collapsed) {
            if (jt(t, n.line, n, i, o) || n.line != i.line && jt(t, i.line, n, i, o))
        ...
        if (t.iter(a, i.line + 1, function(e) {
            ...
            return o.clear()
        }), o.readOnly && (Ot = !0, (t.history.done.length || t.history.undone.length) && t.clearHistory()), o.collapsed && (o.id = ++No, o.atomic = !0), u) {
    ...
    Oo.prototype.clear = function() {
        if (!this.explicitlyCleared) {
            ...
            for (var n = null, i = null, o = 0; o < this.lines.length; ++o) {
                ...
                e && !this.collapsed ? mn(e, it(l), "text") : e && (null != s.to && (i = it(l)), null != s.from && (n = it(l))),
                l.markedSpans = Ht(l.markedSpans, s),
                null == s.from && this.collapsed && !$t(this.doc, l) && e && nt(l, an(e.display))
            }
            ...
            this.atomic && this.doc.cantEdit && (this.doc.cantEdit = !1, e && lo(e.doc)),
    ...
    Oo.prototype.find = function(e, t) {
        ...
        for (var i = 0; i < this.lines.length; ++i) {
            ...
            if (null != l.from && (r = at(t ? o : it(o), l.from), -1 == e))
                return r;
            if (null != l.to && (n = at(t ? o : it(o), l.to), 1 == e))
                return n
        }
        return r && {
                from: r,
    ...
    Oo.prototype.changed = function() {
        ...
        l && a && ni(a, function() {
            var e = l.line,
                t = it(l.line),
                r = Ir(a, t);
            if (r && (Kr(r), a.curOp.selectionChanged = a.curOp.forceUpdate = !0), a.curOp.updateMaxLine = !0, !$t(s.doc, e) && null != s.height) {
                var n = s.height;
                s.height = null;
                var i = Mr(s) - n;
                i && nt(e, e.height + i)
    ...
    Po.prototype = Q(ko.prototype, {
        ...
        clearGutter: li(function(t) {
            ...
            this.iter(function(e) {
                e.gutterMarkers && e.gutterMarkers[t] && So(r, e, "gutter", function() {
                    return e.gutterMarkers[t] = null, re(e.gutterMarkers) && (e.gutterMarkers = null), 1
                })
            })
        }),
        lineInfo: function(e) {
        ...
        addLineWidget: li(function(e, t, r) {
            return i = e, o = new To(n = this, t, r), (l = n.cm) && o.noHScroll && (l.display.alignWidgets = !0), So(n, i, "widget", function(e) {
                var t = e.widgets || (e.widgets = []);
                if (null == o.insertAt ? t.push(o) : t.splice(Math.min(t.length - 1, Math.max(0, o.insertAt)), 0, o), o.line = e, l && !$t(n, e)) {
                ...
                return 1
            }), l && gr(l, "lineWidgetAdded", l, o, "number" == typeof i ? i : it(i)), o;
            var n,
                i,
                o,
                l
        ...
        copy: function(e) {
            var t = new Po(rt(this, this.first, this.first + this.size), this.modeOption, this.first, this.lineSep, this.direction);
        ...
        linkedDoc: function(e) {
            ...
            var n = new Po(rt(this, t, r), e.mode || this.modeOption, t, this.lineSep, this.direction);
        ...
        setDirection: li(function(e) {
            var t;
            "rtl" != e && (e = "ltr"),
            e != this.direction && (this.direction = e, this.iter(function(e) {
                return e.order = null
            }), this.cm && ni(t = this.cm, function() {
                Bi(t),
                vn(t)
            }))
        })
            ...
            if (t && !n.isReadOnly())
                if (r && r.length && window.FileReader && window.File)
                    for (var i = r.length, o = Array(i), l = 0, s = function() {
                            ++l == i && ii(n, function() {
                                var e = {
                                    from: t = gt(n.doc, t),
                                    to: t,
                                    text: n.doc.splitLines(o.filter(function(e) {
                                        return null != e
                                    }).join(n.doc.lineSeparator())),
                                    origin: "paste"
                                };
                                po(n.doc, e),
                                ro(n.doc, Oi(gt(n.doc, t), gt(n.doc, Ai(e))))
                            })()
                        }, a = function(e, t) {
                            if (n.options.allowDropFileTypes && -1 == B(n.options.allowDropFileTypes, e.type))
                                s();
                            else {
                    ...
                    if (n.state.draggingText && -1 < n.doc.sel.contains(t))
                        return n.state.draggingText(e), void setTimeout(function() {
                    ...
                    try {
                        ...
                        if (c) {
                            var h;
                            if (n.state.draggingText && !n.state.draggingText.copy && (h = n.listSelections()), io(n.doc, Oi(t, t)), h)
                                for (var f = 0; f < h.length; ++f)
                                    bo(n.doc, "", h[f].anchor, h[f].head, "drag");
                            n.replaceSelection(c, "around", "paste"),
    ...
    for (var jo = 65; jo <= 90; jo++)
        Vo[jo] = String.fromCharCode(jo);
    for (var Xo = 1; Xo <= 12; Xo++)
        Vo[Xo + 111] = Vo[Xo + 63235] = "F" + Xo;
    var Yo = {};
    function _o(e) {
        var t,
            r,
    ...
    function ol(t, r, s, e) {
        ...
        if (!a)
            return nl(r, s, e);
        s.ch >= r.text.length ? (s.ch = r.text.length, s.sticky = "before") : s.ch <= 0 && (s.ch = 0, s.sticky = "after");
        ...
        function o(e) {
            return t.options.lineWrapping ? (l = l || zr(t, r), on(t, r, l, e)) : {
                begin: 0,
                end: r.text.length
            }
        }
            ...
            return ni(l, function() {
                for (var e = l.listSelections(), t = [], r = 0; r < e.length; r++)
                    if (e[r].empty()) {
                        ...
                        if (i)
                            if (n.ch == i.length && (n = new at(n.line, n.ch - 1)), 0 < n.ch)
                                ...
                                o && (n = new at(n.line, 1), l.replaceRange(i.charAt(0) + l.doc.lineSeparator() + o.charAt(o.length - 1), at(n.line - 1, o.length - 1), n, "+transpose"))
                            }
                        t.push(new Mi(n, n))
                    }
                l.setSelections(t)
    ...
    function hl(e, t, r, n) {
        ...
        if (i) {
            if (Zo(t))
                return "handled";
            if (/\'$/.test(t) ? e.state.keySeq = null : cl.set(50, function() {
    ...
    function fl(e, t, r, n) {
        var i = function(e, t, r) {
            ...
            return e.options.extraKeys && qo(t, e.options.extraKeys, r, e) || qo(t, e.options.keyMap, r, e)
        }(e, t, n);
        return "multi" == i && (e.state.keySeq = t), "handled" == i && gr(e, "keyHandled", e, t, r), "handled" != i && "multi" != i || (Ne(r), Tn(e)), !!i
    }
    function dl(t, e) {
        var r = Jo(e, !0);
        return !!r && (e.shiftKey && !t.state.keySeq ? hl(t, "Shift-" + r, e, function(e) {
                return ul(t, e, !0)
            }) || hl(t, r, e, function(e) {
    ...
    function gl(e) {
        ...
        if (t.curOp.focus = W(), !Le(t, e)) {
            ...
            var n,
                i = dl(t, e);
            v && (pl = i ? r : null, !i && 88 == r && !Ue && (w ? e.metaKey : e.ctrlKey) && t.replaceSelection("", null, "cut")),
            g && !w && !i && 46 == r && e.shiftKey && !e.ctrlKey && document.execCommand && document.execCommand("cut"),
            18 != r || /\bCodeMirror-crosshair\b/.test(t.display.lineDiv.className) || (H(n = t.display.lineDiv, "CodeMirror-crosshair"), we(document, "keyup", o), we(document, "mouseover", o))
        }
        function o(e) {
            18 != e.keyCode && e.altKey || (T(n, "CodeMirror-crosshair"), Ce(document, "keyup", o), Ce(document, "mouseover", o))
        }
    }
    function vl(e) {
    ...
    function ml(e) {
        var t = this;
        if (!(Nr(t.display, e) || Le(t, e) || e.ctrlKey && !e.altKey || w && e.metaKey)) {
            var r = e.keyCode,
                n = e.charCode;
            if (v && r == pl)
                return pl = null, void Ne(e);
            if (!v || e.which && !(e.which < 10) || !dl(t, e)) {
                var i,
                    o = String.fromCharCode(null == n ? r : n);
                if ("\b" != o)
                    if (!hl(i = t, "'" + o + "'", e, function(e) {
                        return ul(i, e, !0)
                    }))
    ...
    function xl(e) {
        ...
        if (!(Le(t, e) || r.activeTouch && r.input.supportsTouch()))
            if (r.input.ensurePolled(), r.shift = e.shiftKey, Nr(r, e))
                b || (r.scroller.draggable = !1, setTimeout(function() {
                ...
                var n,
                    ...
                    l = pn(t, e),
                    s = He(e),
                    a = l ? (n = l, i = s, o = +new Date, bl && bl.compare(o, n, i) ? (yl = bl = null, "triple") : yl && yl.compare(o, n, i) ? (bl = new wl(o, n, i), yl = null, "double") : (yl = new wl(o, n, i), bl = null, "single")) : "single";
                window.focus(),
                1 == s && t.state.selectingText && t.state.selectingText(e),
                l && function(r, e, n, t, i) {
                    var o = "Click";
                    "double" == t ? o = "Double" + o : "triple" == t && (o = "Triple" + o);
                    return hl(r, Qo(o = (1 == e ? "Left" : 2 == e ? "Middle" : "Right") + o, i), i, function(e) {
                        if ("string" == typeof e && (e = ll[e]), !e)
                            return !1;
                        var t = !1;
                        try {
                    ...
                    (e.options.dragDrop && Ee && !e.isReadOnly() && "single" == r && -1 < (i = l.contains(t)) && (ut((i = l.ranges[i]).from(), t) < 0 || 0 < t.xRel) && (0 < ut(i.to(), t) || t.xRel < 0) ? function(t, r, n, i) {
                        var o = t.display,
                            ...
                            s = ii(t, function(e) {
                                ...
                                l || (Ne(e), i.addNew || Qi(t.doc, n, null, null, i.extend), b || x && 9 == C ? setTimeout(function() {
                        ...
                        var w,
                            ...
                            C = b.sel,
                            t = C.ranges;
                        y.addNew && !y.extend ? (x = b.sel.contains(m), w = -1 < x ? t[x] : new Mi(m, m)) : (w = b.sel.primary(), x = b.sel.primIndex);
                        if ("rectangle" == y.unit)
                            ...
                            var r = Cl(v, m, y.unit);
                            w = y.extend ? Zi(w, r.anchor, r.head, y.extend) : r
                        }
                        y.addNew ? -1 == x ? (x = t.length, no(b, Ni(v, t.concat([w]), x), {
                            scroll: !1,
                            origin: "*mouse"
                        })) : 1 < t.length && t[x].empty() && "char" == y.unit && !y.extend ? (no(b, Ni(v, t.slice(0, x).concat(t.slice(x + 1)), 0), {
                            scroll: !1,
                            origin: "*mouse"
                        }), C = b.sel) : eo(b, x, w, K) : (no(b, new Ti([w], x = 0), K), C = b.sel);
                        var S = m;
                        function s(e) {
                            if (0 != ut(S, e))
                                if (S = e, "rectangle" == y.unit) {
                                    for (var t = [], r = v.options.tabSize, n = z(et(b, m.line).text, m.ch, r), i = z(et(b, e.line).text, e.ch, r), o = Math.min(n, i), l = Math.max(n, i), s = Math.min(m.line, e.line), a = Math.min(v.lastLine(), Math.max(m.line, e.line)); s <= a; s++) {
                                        var u = et(b, s).text,
                                            c = X(u, o, r);
                                        o == l ? t.push(new Mi(at(s, c), at(s, c))) : u.length > c && t.push(new Mi(at(s, c), at(s, X(u, l, r))))
                                    }
                                    t.length || t.push(new Mi(m, m)),
                                    no(b, Ni(v, C.ranges.slice(0, x).concat(t), x), {
                                        origin: "*mouse",
                                        scroll: !1
                                    }),
                                    v.scrollIntoView(e)
                                    ...
                                    var h,
                                        ...
                                        d = Cl(v, e, y.unit),
                                        p = f.anchor;
                                    p = 0 < ut(d.anchor, p) ? (h = d.head, dt(f.from(), d.anchor)) : (h = d.anchor, ft(f.to(), d.head));
                                    ...
                                    g[x] = function(e, t) {
                                        ...
                                        var f = o[u + (a ? -1 : 0)],
                                            ...
                                            p = d ? f.from : f.to,
                                            g = d ? "after" : "before";
                                        return r.ch == p && r.sticky == g ? t : new Mi(new at(r.line, p, g), n)
                                    }(v, new Mi(gt(b, p), h)),
                                    no(b, Ni(v, g, x), K)
                                }
                        }
                                ...
                                (0 !== e.buttons && He(e) ? function e(t) {
                                    ...
                                    if (n)
                                        if (0 != ut(n, S)) {
                                            ...
                                            s(n);
                                            var i = Hn(l, b);
                                            (n.line >= i.to || n.line < i.from) && setTimeout(ii(v, function() {
                                                u == r && e(t)
                                            }), 150)
                                        } else {
                                            var o = t.clientY < a.top ? -20 : t.clientY > a.bottom ? 20 : 0;
                                            o && setTimeout(ii(v, function() {
                                                u == r && (l.scroller.scrollTop += o, e(t))
                                            }), 50)
                                        }
                                } : n)(e)
                            }),
                ...
                }(t, l, a, e) : We(e) == r.scroller && Ne(e) : 2 == s ? (l && Qi(t.doc, l), setTimeout(function() {
                    return r.input.focus()
                }, 20)) : 3 == s && (S ? t.display.input.onContextMenu(e) : Nn(t)))
            }
    }
    function Cl(e, t, r) {
        if ("char" == r)
        ...
        if ("line" == r)
            return new Mi(at(t.line, 0), gt(e.doc, at(t.line + 1, 0)));
        var n = r(e, t);
    ...
    function Sl(e, t, r, n) {
        ...
        for (var a = 0; a < e.display.gutterSpecs.length; ++a) {
            ...
            if (u && u.getBoundingClientRect().right >= i)
                return Se(e, r, e, ot(e.doc, o), e.display.gutterSpecs[a].className, t), Ae(t)
        }
    }
    function Ll(e, t) {
    ...
    function kl(e, t) {
        var r,
            n;
        Nr(e.display, t) || (n = t, Te(r = e, "gutterContextMenu") && Sl(r, n, "gutterContextMenu", !1)) || Le(e, t, "contextmenu") || S || e.display.input.onContextMenu(t)
    }
    function Tl(e) {
    ...
    function Dl(e) {
        e.options.lineWrapping ? (H(e.display.wrapper, "CodeMirror-wrap"), e.display.sizer.style.minWidth = "", e.display.sizerWidth = null) : (T(e.display.wrapper, "CodeMirror-wrap"), Jt(e)),
        dn(e),
        vn(e),
        Xr(e),
        setTimeout(function() {
    ...
    function Wl(e, t) {
        ...
        I(Nl, t, !1);
        var n = t.value;
        "string" == typeof n ? n = new Po(n, t.mode, null, t.lineSeparator, t.direction) : t.mode && (n.modeOption = t.mode),
        this.doc = n;
        var i = new Wl.inputStyles[t.inputStyle](this),
            o = this.display = new wi(e, n, i, t);
        for (var l in Tl(o.wrapper.CodeMirror = this), t.lineWrapping && (this.display.wrapper.className += " CodeMirror-wrap"), $n(this), this.state = {
            keyMaps: [],
            overlays: [],
            modeGen: 0,
            overwrite: !1,
            ...
            keySeq: null,
            specialChars: null
        }, t.autofocus && !f && o.input.focus(), x && C < 11 && setTimeout(function() {
            return r.display.input.reset(!0)
        }, 20), function(i) {
            var o = i.display;
            we(o.scroller, "mousedown", ii(i, xl)),
            we(o.scroller, "dblclick", x && C < 11 ? ii(i, function(e) {
                if (!Le(i, e)) {
                    var t = pn(i, e);
            ...
            we(o.scroller, "touchend", function(e) {
                var t = o.activeTouch;
                if (t && !Nr(o, e) && null != t.left && !t.moved && new Date - t.start < 300) {
                    var r,
                        n = i.coordsChar(o.activeTouch, "page");
                    r = !t.prev || s(t, t.prev) ? new Mi(n, n) : !t.prev.prev || s(t, t.prev.prev) ? i.findWordAt(n) : new Mi(at(n.line, 0), gt(i.doc, at(n.line + 1, 0))),
            ...
            we(o.scroller, "scroll", function() {
                o.scroller.clientHeight && (Bn(i, o.scroller.scrollTop), Un(i, o.scroller.scrollLeft, !0), Se(i, "scroll", i))
            }),
            ...
            o.dragFunctions = {
                ...
                over: function(e) {
                    Le(i, e) || (function(e, t) {
                        ...
                        if (r) {
                            ...
                            Sn(e, r, n),
                            e.display.dragCursor || (e.display.dragCursor = A("div", null, "CodeMirror-cursors CodeMirror-dragcursors"), e.display.lineSpace.insertBefore(e.display.dragCursor, e.display.cursorDiv)),
                ...
                start: function(e) {
                    return function(e, t) {
                        if (x && (!e.state.draggingText || new Date - Eo < 100))
                            De(t);
                        else if (!Le(e, t) && !Nr(e.display, t) && (t.dataTransfer.setData("Text", e.getSelection()), t.dataTransfer.effectAllowed = "copyMove", t.dataTransfer.setDragImage && !a)) {
                            ...
                            v && (r.width = r.height = 1, e.display.wrapper.appendChild(r), r._top = r.offsetTop),
        ...
        }(this), Go(), Zn(this), this.curOp.forceUpdate = !0, Ri(this, n), t.autofocus && !f || this.hasFocus() ? setTimeout(E(On, this), 20) : An(this), Ol)
    ...
    function Fl(e, t, r, n) {
        ...
        if (e.options.indentWithTabs)
            for (var d = Math.floor(u / l); d; --d)
                ...
                h += "\t";
        if (f < u && (h += _(u - f)), h != c)
            return bo(o, h, at(t, 0), at(t, c.length), "+input"), !(s.stateAfter = null);
    ...
    function Il(e, t, r, n, i) {
        ...
        for (var h = e.curOp.updateInput, f = n.ranges.length - 1; 0 <= f; f--) {
            var d = n.ranges[f],
                p = d.from(),
                g = d.to();
            d.empty() && (r && 0 < r ? p = at(p.line, p.ch - r) : e.state.overwrite && !s ? g = at(g.line, Math.min(et(o, g.line).text.length, g.ch + $(a).length)) : s && Pl && Pl.lineWise && Pl.text.join("\n") == t && (p = g = at(p.line, 0)));
            var v = {
                from: p,
                to: g,
    ...
    function zl(e, t) {
        ...
        return r && (e.preventDefault(), t.isReadOnly() || t.options.disableInput || ni(t, function() {
            ...
            for (var r = e.doc.sel, n = r.ranges.length - 1; 0 <= n; n--) {
                ...
                if (!(100 < i.head.ch || n && r.ranges[n - 1].head.line == i.head.line)) {
                    ...
                    if (o.electricChars) {
                        ...
                        o.electricInput && o.electricInput.test(et(e.doc, i.head.line).text.slice(0, i.head.ch)) && (l = Fl(e, i.head.line, "smart"));
    ...
    function Ul() {
        ...
        return b ? e.style.width = "1000px" : e.setAttribute("wrap", "off"), c && (e.style.border = "1px solid black"), Gl(e), t
    }
    function Vl(n, i, o, e, l) {
        ...
        function u(e) {
            ...
            if (null == (t = l ? ol(n.cm, s, i, o) : nl(s, i, o))) {
                if (e || (r = i.line + a) < n.first || r >= n.first + n.size || (i = new at(r, i.ch, i.sticky), !(s = et(n, r))))
                    return;
        ...
        if ("char" == e)
            ...
            for (var c = null, h = "group" == e, f = n.cm && n.cm.getHelper(i, "wordChars"), d = !0; !(o < 0) || u(!d); d = !1) {
    ...
    jl.prototype.init = function(e) {
        ...
        function r(e) {
            if (!Le(s, e)) {
                ...
                if (e.clipboardData) {
                    ...
                    var r = Pl.text.join("\n");
                    if (e.clipboardData.setData("Text", r), e.clipboardData.getData("Text") == r)
        ...
        Gl(a, s.options.spellcheck, s.options.autocorrect, s.options.autocapitalize),
        we(a, "paste", function(e) {
            Le(s, e) || zl(e, s) || C <= 11 && setTimeout(ii(s, function() {
        ...
        if (t.display.viewTo == t.display.viewFrom || n.line >= t.display.viewTo || i.line < t.display.viewFrom)
            ...
            if (!o || o.bad || !l || l.bad || 0 != ut(dt(o, l), n) || 0 != ut(ft(o, l), i)) {
                ...
                if (a && u) {
                    ...
                    f && (!g && t.state.focused ? (e.collapse(a.node, a.offset), f.collapsed || (e.removeAllRanges(), e.addRange(f))) : (e.removeAllRanges(), e.addRange(f)), d && null == e.anchorNode ? e.addRange(d) : g && this.startGracePeriod()),
    ...
    jl.prototype.pollContent = function() {
        ...
        var e,
            ...
            l = o.from(),
            s = o.to();
        if (0 == l.ch && l.line > n.firstLine() && (l = at(l.line - 1, et(n.doc, l.line - 1).length)), s.ch == et(n.doc, s.line).text.length && s.line < n.lastLine() && (s = at(s.line + 1, 0)), l.line < i.viewFrom || s.line > i.viewTo - 1)
            return !1;
        r = l.line == i.viewFrom || 0 == (e = gn(n, l.line)) ? (t = it(i.view[0].line), i.view[0].node) : (t = it(i.view[e].line), i.view[e - 1].node.nextSibling);
        var a,
            u,
            c = gn(n, s.line);
        if (u = c == i.view.length - 1 ? (a = i.viewTo - 1, i.lineDiv.lastChild) : (a = it(i.view[c + 1].line) - 1, i.view[c + 1].node.previousSibling), !r)
            return !1;
        for (var h = n.doc.splitLines(function(a, e, t, u, c) {
                ...
                function v(e) {
                    if (1 == e.nodeType) {
                        ...
                        if (n) {
                            var i = a.findMarks(at(u, 0), at(c + 1, 0), (s = +n, function(e) {
                                return e.id == s
                            }));
                            return void (i.length && (r = i[0].find(0)) && g(tt(a.doc, r.from, r.to).join(f)))
                        }
                        ...
                        for (var l = 0; l < e.childNodes.length; l++)
                            v(e.childNodes[l]);
                        /^(pre|p)$/i.test(e.nodeName) && (d = !0),
                        o && (h = !0)
                    } else
                        3 == e.nodeType && g(e.nodeValue.replace(/\u200b/g, "").replace(/\u00a0/g, " "));
                    var s
                }
                for (; v(e), e != t;)
                    e = e.nextSibling,
        ...
        return 1 < h.length || h[0] || ut(x, C) ? (bo(n.doc, h, x, C, "+input"), !0) : void 0
    },
    ...
    jl.prototype.onKeyPress = function(e) {
        0 == e.charCode || this.composing || (e.preventDefault(), this.cm.isReadOnly() || ii(this.cm, Il)(this.cm, String.fromCharCode(null == e.charCode ? e.keyCode : e.charCode), 0))
    },
    ...
    ql.prototype.init = function(r) {
        ...
        function t(e) {
            if (!Le(i, e)) {
                if (i.somethingSelected())
                    ...
                    "cut" == e.type ? i.setSelections(t.ranges, null, V) : (n.prevInput = "", o.value = t.text.join("\n"), P(o))
                }
        ...
        we(o, "paste", function(e) {
            Le(i, e) || zl(e, i) || (i.state.pasteIncoming = +new Date, n.fastPoll())
        }),
        we(o, "cut", t),
        we(o, "copy", t),
    ...
    ql.prototype.reset = function(e) {
        if (!this.contextMenuPending && !this.composing) {
            ...
            if (t.somethingSelected()) {
                ...
                e || (this.prevInput = this.textarea.value = "", x && 9 <= C && (this.hasSelection = null))
        }
    },
    ...
    ql.prototype.poll = function() {
        ...
        return ni(t, function() {
            Il(t, i.slice(l), n.length - l, null, e.composing ? "*compose" : null),
    ...
    ql.prototype.onContextMenu = function(e) {
        ...
        if (t && !v) {
            n.options.resetSelectionOnContextMenu && -1 == n.doc.sel.contains(t) && ii(n, no)(n.doc, Oi(t), V);
            var s,
                a = o.style.cssText,
                u = r.wrapper.style.cssText,
                c = r.wrapper.offsetParent.getBoundingClientRect();
            if (r.wrapper.style.cssText = "position: static", o.style.cssText = "position: absolute; width: 30px; height: 30px;\n      top: " + (e.clientY - c.top - 5) + "px; left: " + (e.clientX - c.left - 5) + "px;\n      z-index: 1000; background: " + (x ? "rgba(255, 255, 255, .05)" : "transparent") + ";\n      outline: none; border-width: 0; outline: none; overflow: hidden; opacity: .05; filter: alpha(opacity=5);", b && (s = window.scrollY), i.input.focus(), b && window.scrollTo(null, s), i.input.reset(), n.somethingSelected() || (o.value = r.prevInput = " "), r.contextMenuPending = d, i.selForContextMenu = n.doc.sel, clearTimeout(i.detectingSelectAll), x && 9 <= C && f(), S) {
                De(e);
                var h = function() {
                    Ce(window, "mouseup", h),
                    setTimeout(d, 20)
        ...
        function d() {
            if (r.contextMenuPending == d && (r.contextMenuPending = !1, r.wrapper.style.cssText = u, o.style.cssText = a, x && C < 9 && i.scrollbars.setScrollTop(i.scroller.scrollTop = l), null != o.selectionStart)) {
                (!x || x && C < 9) && f();
                var e = 0,
                    t = function() {
                        i.selForContextMenu == n.doc.sel && 0 == o.selectionStart && 0 < o.selectionEnd && "​" == r.prevInput ? ii(n, ho)(n) : e++ < 10 ? i.detectingSelectAll = setTimeout(t, 500) : (i.selForContextMenu = null, i.input.reset())
                    };
    ...
    Zl.defineOption = rs,
    Zl.Init = Ml,
    rs("value", "", function(e, t) {
        return e.setValue(t)
    }, !0),
    rs("mode", null, function(e, t) {
        e.doc.modeOption = t,
        Fi(e)
    }, !0),
    ...
    rs("specialChars", /[\u0000-\u001f\u007f-\u009f\u00ad\u061c\u200b-\u200f\u2028\u2029\ufeff\ufff9-\ufffc]/g, function(e, t, r) {
        e.state.specialChars = new RegExp(t.source + (t.test("\t") ? "" : "|\t"), "g"),
        r != Ml && e.refresh()
    }),
    rs("specialCharPlaceholder", or, function(e) {
        return e.refresh()
    }, !0),
    rs("electricChars", !0),
    rs("inputStyle", f ? "contenteditable" : "textarea", function() {
        throw new Error("inputStyle can not (yet) be changed in a running editor")
    }, !0),
    rs("spellcheck", !1, function(e, t) {
        return e.getInputField().spellcheck = t
    }, !0),
    rs("autocorrect", !1, function(e, t) {
        return e.getInputField().autocorrect = t
    }, !0),
    rs("autocapitalize", !1, function(e, t) {
        return e.getInputField().autocapitalize = t
    }, !0),
    rs("rtlMoveVisually", !p),
    rs("wholeLineUpdateBefore", !0),
    rs("theme", "default", function(e) {
        Tl(e),
        bi(e)
    }, !0),
    ...
    rs("disableInput", !1, function(e, t) {
    ...
    rs("viewportMargin", 10, function(e) {
        return e.refresh()
    }, !0),
    ...
    Jl.prototype = {
        ...
        setOption: function(e, t) {
            var r = this.options,
                n = r[e];
            r[e] == t && "mode" != e || (r[e] = t, es.hasOwnProperty(e) && ii(this, es[e])(this, t, n), Se(this, "optionChange", this, e))
        },
        ...
        indentSelection: oi(function(e) {
            for (var t = this.doc.sel.ranges, r = -1, n = 0; n < t.length; n++) {
                var i = t[n];
                if (i.empty())
                    i.head.line > r && (Fl(this, i.head.line, e, !0), r = i.head.line, n == this.doc.sel.primIndex && En(this));
                else {
                    var o = i.from(),
                        l = i.to(),
                        s = Math.max(r, o.line);
                    ...
                    0 == o.ch && t.length == u.length && 0 < u[n].from().ch && eo(this.doc, n, new Mi(o, u[n].to()), V)
                }
            }
        }),
        ...
        cursorCoords: function(e, t) {
            ...
            return Jr(this, null == e ? r.head : "object" == typeof e ? gt(this.doc, e) : e ? r.from() : r.to(), t || "page")
        },
        ...
        heightAtLine: function(e, t, r) {
            ...
            if ("number" == typeof e) {
                ...
                e < this.doc.first ? e = this.doc.first : o < e && (e = o, i = !0),
                n = et(this.doc, e)
            } else
                n = e;
            return qr(this, n, {
        ...
        addWidget: function(e, t, r, n, i) {
            var o,
                ...
                c = e.left;
            if (t.style.position = "absolute", t.setAttribute("cm-ignore-events", "true"), this.display.input.setUneditable(t), a.sizer.appendChild(t), "over" == n)
                u = e.top;
                ...
                ("above" == n || e.bottom + t.offsetHeight > h) && e.top > t.offsetHeight ? u = e.top - t.offsetHeight : e.bottom + t.offsetHeight <= h && (u = e.bottom),
                c + t.offsetWidth > f && (c = f - t.offsetWidth)
            }
            t.style.top = u + "px",
            t.style.left = t.style.right = "",
            "right" == i ? (c = a.sizer.clientWidth - t.offsetWidth, t.style.right = "0px") : ("left" == i ? c = 0 : "middle" == i && (c = (a.sizer.clientWidth - t.offsetWidth) / 2), t.style.left = c + "px"),
            r && (o = this, l = {
                left: c,
                top: u,
                right: c + t.offsetWidth,
                bottom: u + t.offsetHeight
            }, null != (s = Fn(o, l)).scrollTop && Bn(o, s.scrollTop), null != s.scrollLeft && Un(o, s.scrollLeft))
        },
        ...
        findPosH: function(e, t, r, n) {
            var i = 1;
            t < 0 && (i = -1, t = -t);
            for (var o = gt(this.doc, e), l = 0; l < t && !(o = Vl(this.doc, o, i, r, n)).hitSide; ++l)
                ;
            return o
        },
        moveH: oi(function(t, r) {
            ...
            this.extendSelectionsBy(function(e) {
                return n.display.shift || n.doc.extend || e.empty() ? Vl(n.doc, e.head, t, r, n.options.rtlMoveVisually) : t < 0 ? e.from() : e.to()
            }, j)
        }),
        deleteH: oi(function(r, n) {
            var e = this.doc.sel,
                i = this.doc;
            e.somethingSelected() ? i.replaceSelection("", null, "+delete") : tl(this, function(e) {
        ...
        findPosV: function(e, t, r, n) {
            ...
            for (var l = gt(this.doc, e), s = 0; s < t; ++s) {
                var a = Jr(this, l, "div");
                if (null == o ? o = a.left : a.left = o, (l = Kl(this, a, i, r)).hitSide)
                    break
            }
            return l
        },
        moveV: oi(function(n, i) {
            ...
            if (l.extendSelectionsBy(function(e) {
                ...
                s.push(t.left);
                var r = Kl(o, t, n, i);
                return "page" == i && e == l.sel.primary() && Pn(o, Qr(o, r, "div").top - t.top), r
            }, j), s.length)
        ...
        toggleOverwrite: function(e) {
            null != e && e == this.state.overwrite || (((this.state.overwrite = !this.state.overwrite) ? H : T)(this.display.cursorDiv, "CodeMirror-overwrite"), Se(this, "overwriteToggle", this, this.state.overwrite))
        },
        hasFocus: function() {
        ...
        scrollIntoView: oi(function(e, t) {
            ...
            e.to || (e.to = e.from),
            e.margin = t || 0,
            null != e.from.line ? (n = e, zn(r = this), r.curOp.scrollToPos = n) : Rn(this, e.from, e.to, e.margin)
        }),
        ...
        refresh: oi(function() {
            ...
            di(this.display),
            (null == e || .5 < Math.abs(e - an(this.display))) && dn(this),
            Se(this, "refresh", this)
        }),
        swapDoc: oi(function(e) {
            var t = this.doc;
            return t.cm = null, this.state.selectingText && this.state.selectingText(), Ri(this, e), Xr(this), this.display.input.reset(), In(this, e.scrollLeft, e.scrollTop), this.curOp.forceScroll = !0, gr(this, "swapDoc", this, t), t
        }),
        phrase: function(e) {
    ...
    Jl.registerHelper = function(e, t, r) {
        ts.hasOwnProperty(e) || (ts[e] = Jl[e] = {
            _global: []
        }),
        ts[e][t] = r
    },
    Jl.registerGlobalHelper = function(e, t, r, n) {
        Jl.registerHelper(e, t, n),
        ts[e]._global.push({
            pred: r,
            val: n
        })
    ...
    for (var os in Po.prototype)
        Po.prototype.hasOwnProperty(os) && B(is, os) < 0 && (Wl.prototype[os] = function(e) {
            return function() {
                return e.apply(this.doc, arguments)
            }
        }(Po.prototype[os]));
    return Me(Po), Wl.inputStyles = {
        textarea: ql,
        contenteditable: jl
    ...
    }), Wl.defineMIME("text/plain", "null"), Wl.defineExtension = function(e, t) {
        Wl.prototype[e] = t
    }, Wl.defineDocExtension = function(e, t) {
        Po.prototype[e] = t
    }, Wl.fromTextArea = function(t, r) {
        if ((r = r ? I(r) : {}).value = t.value, !r.tabindex && t.tabIndex && (r.tabindex = t.tabIndex), !r.placeholder && t.placeholder && (r.placeholder = t.placeholder), null == r.autofocus) {
            var e = W();
            r.autofocus = e == t || null != t.getAttribute("autofocus") && e == document.body
        }
        function n() {
            t.value = s.getValue()
        }
        ...
        r.finishInit = function(e) {
            ...
            e.toTextArea = function() {
                ...
                t.style.display = "",
                t.form && (Ce(t.form, "submit", n), r.leaveSubmitMethodAlone || "function" != typeof t.form.submit || (t.form.submit = i))
            }
        },
